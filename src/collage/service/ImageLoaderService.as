...
public class ImageLoaderService extends Actor {
    [Inject] public var imagesModel:ImagesModel;
    ...
    public function loadInitialImages():void {
        ...
        var urls:Array = imagesModel.getInitialImages();
    ...
    private function imagesLoadedCallback(event:LoaderEvent):void {
        ...
        imagesModel.initialImagesLoaded(loader.content);
    }
    ...
    private function imageFailedCallback(event:LoaderEvent):void {
        ...
        _failed = true;
        imagesModel.failedToLoadImage();
    }

    public function loadImage(imageName:String):void {
        var imageToLoad:String = imagesModel.getNextImageToLoad(imageName);
    ...
    private function imageLoadedCallback(event:LoaderEvent):void {
        ...
        imagesModel.imagesLoaded(loader.vars.prevImage, loader.url, loader.rawContent);
    }
}
}
